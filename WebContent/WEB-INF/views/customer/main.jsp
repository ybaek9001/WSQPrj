...
<body>
	...
	<div id="visual">
		<img src="images/bg.png" alt="bg" class="bg_chat1" />
		<img src="images/chat.png" alt="bg" class="bg_chat2"/>
	</div>
		...
		<div class="content-container clearfix">
			...
			<div>
				...
				<dl>
					...
					<a href=""> <img src="images/find.png" alt="find_partner" />
					</a>
					<dt>Find Chat Partner</dt>
					<dd>전 세계 사람들과 언어교환을 할 수 있도록 쉽게 파트너를 찾아주는 기능입니다</dd>
					
					
					<a href="customer/debate.html"> <img src="images/debate.png" alt="debate" class="img_debate"/>
					</a>
					<dt>WSQ Debate</dt>
